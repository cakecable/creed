...
var consoleLine = new Typed('#user-line', {
  strings: ['<span>sudo apt-get install <em>stupid_members</em>'],
  typeSpeed: 0,
  backSpeed: 1,
  cursorChar: '|',
  onComplete: function () {
    ...
    var consoleLine = new Typed('#console-line', {
      strings: ['<span>Reading package lists... Done<br>Building dependency tree<br>Reading state information... Done<br>Calculating <em>stupid_members</em>... Done'],
      typeSpeed: 0,
      backSpeed: 0,
      cursorChar: '',
      onComplete: function () {

        $('.user-line2 p').css('display', 'block');
        var consoleLine = new Typed('#user-line2', {
          ...
          onComplete: function () {
            ...
            var consoleLine = new Typed('#user-line3', {
              strings: ['<span>tree /<em>stupid_members</em>'],
              typeSpeed: 0,
              backSpeed: 0,
              cursorChar: '|ˆ',
              onComplete: function () {
